...
const colorVariants = {
  blue: 'bg-blue-b-200 border-blue-b-200 text-primary-g-800 fill-primary-g-800 hover:fill-neutral-n-500 duration-200',
  green:
    'bg-primary-g-100 border-primary-g-100 text-primary-g-700 fill-primary-g-700 hover:fill-neutral-n-700  duration-200',
  neutral:
    'bg-neutral-n-300 border-neutral-n-300 text-neutral-n-800 fill-neutral-n-800 hover:fill-neutral-n-600 duration-200',
  orange:
    'bg-orange-o-100 border-orange-o-100 text-orange-o-700 fill-orange-o-700 hover:fill-orange-o-400 duration-200',
  red: 'bg-red-r-200 border-red-r-200 text-red-r-800 fill-red-r-800 hover:fill-red-r-400 duration-200'
};

const bgIcon = {
  feature: 'bg-blue-b-200',
  success: 'bg-primary-g-300',
  neutral: 'bg-neutral-n-100',
...
const alertTypeIconsMap: Record<keyof typeof AlertTypes, JSX.Element> = {
  ...
  return (
    <div
      className={cn(
        AlertTypes[variant],
        className,
        'w-[full] h-[60px] py-7 px-4 flex items-center justify-between gap-6 rounded-2xl'
      )}
      {...props}
    >
      <div className="flex items-center gap-4 w-full">
        <div
          className={cn(
            'w-[32px] h-[32px] flex items-center justify-center rounded-lg  p-1 basis-8'
          )}
        >
          {alertTypeIconsMap[variant]}
        </div>
        <div className="max-w-96 w-full min-w-60 flex flex-col justify-center">
      ...
      <div className="flex justify-center items-center gap-4">
        ...
        <div onClick={onClose} className="cursor-pointer">
          <svg
            ...
            viewBox="0 0 24 24"
            fill="none"
            className={cn(AlertTypes[variant])}
          >

...
# from backend.app.models.user import UserTalentHub


# class RecruitmentAnalyticsService:
#     def get_pipeline_metrics(
#         self, db: Session, user: UserTalentHub, time_range: str = "all"
#     ) -> Dict:
...
#             applications_query = (
#                 db.query(JobApplication).join(Position).filter(Position.recruiter_id == user.id)
#             )
...
#                     JobApplication.created_at >= date_filter
#                 )
...
#             status_counts = (
#                 applications_query.with_entities(
...
#                 "applications_per_position": total_applications / total_positions
...
#             return {
#                 "conversion_rate": hired_count / total_applications

...
# from app.models.careerforge.career import Experience, JobApplication, Milestone
...
#         self, db: Session, user: UserCareerForge, time_range: str = "all"
#     ) -> Dict:
...
#             status_counts = (
#                 query.with_entities(JobApplication.status, func.count(JobApplication.id))

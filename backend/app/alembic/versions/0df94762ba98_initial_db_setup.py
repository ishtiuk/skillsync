...
Revision ID: 0df94762ba98
Revises: 
Create Date: 2025-06-05 01:59:30.879713
...
def upgrade() -> None:
    ...
    op.create_table('user_careerforge',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    op.create_table('user_talenthub',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('base_user_id', sa.UUID(), nullable=False),
    sa.Column('email', sa.String(), nullable=False),
    sa.Column('password_hash', sa.String(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user_careerforge.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['created_by'], ['user_talenthub.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user_talenthub.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['job_id'], ['positions.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user_careerforge.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
